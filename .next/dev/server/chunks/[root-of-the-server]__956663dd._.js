...
"[project]/app/api/weekly-ratings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getWeeklyRatingCollection() {
    ...
    return db.collection("weeklyRatings");
}
async function GET(request) {
    ...
    try {
        ...
        const weeklyRatings = await weeklyRatingCollection.find({
            userId
        }).toArray();
...
async function POST(request) {
    ...
    if (!weekStart || !weekEnd || !rating || !userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "weekStart, weekEnd, rating and userId are required"
        }, {
            status: 400
        });
    }
    const newWeeklyRating = {
        weekStart,
        weekEnd,
        rating,
        notes,
    ...
    try {
        const weeklyRatingCollection = await getWeeklyRatingCollection();
        const result = await weeklyRatingCollection.insertOne(newWeeklyRating);
        const insertedWeeklyRating = {
            ...newWeeklyRating,
            id: result.insertedId.toString()
        };
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(insertedWeeklyRating, {
            status: 201
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Failed to create weekly rating",
            error: error.message
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__956663dd._.js.map